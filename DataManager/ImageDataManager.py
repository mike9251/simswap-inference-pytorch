...
from SimSwapInference.DataManager.utils import imread_rgb, imwrite_rgb
...
if __name__ == "__main__":
    dm = ImageDataManager(src_data=Path(r"C:\Users\petrush\Downloads\SimSwap\demo_file\multispecific"),
